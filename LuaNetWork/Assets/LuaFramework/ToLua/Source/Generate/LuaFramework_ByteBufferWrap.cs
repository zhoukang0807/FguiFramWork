...
public class LuaFramework_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("WriteTString", WriteTString);
		...
		L.RegFunction("ReadTString", ReadTString);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int WriteTString(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ReadTString(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			LuaFramework.ByteBuffer obj = (LuaFramework.ByteBuffer)ToLua.CheckObject<LuaFramework.ByteBuffer>(L, 1);
			string o = obj.ReadTString();
			LuaDLL.lua_pushstring(L, o);
			return 1;
		}
		catch (Exception e)
